...
export class DemoFilePickerAdapter extends FilePickerAdapter {
  ...
  public uploadFile(fileItem: FilePreviewModel) {
    ...
    const api = 'https://db.andesproadventures.com:3015/api/containers/tixsImages/upload';
    ...
    .pipe(
      map( (res: HttpEvent<any>) => {
         ...
         this._uw.images.push('https://db.andesproadventures.com/imgPrasi/server/local-storage/tixsImages/'+this._uw.file[0].name);
